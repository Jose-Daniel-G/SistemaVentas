...
@section('content_header')
    <h1>Productos/Actualizar producto</h1>
@stop
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="stock_min" class="form-control"
                                        value="{{ $product->stock_min }}" placeholder="Ingrese el stock_min">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="stock_max" class="form-control"
                                        value="{{ $product->stock_max }}" placeholder="Ingrese el stock maximo">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="purchase_price" class="form-control"
                                        value="{{ $product->purchase_price }}" placeholder="Ingrese el nombre de la producto">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="sale_price" class="form-control"
                                        value="{{ $product->sale_price }}" placeholder="Ingrese el nombre de la producto">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="admission_date" class="form-control"
                                        value="{{ $product->admission_date }}" placeholder="Ingrese el nombre de la producto">
                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" cols="10" rows="2" class="form-control">{{ $product->description}}</textarea>
