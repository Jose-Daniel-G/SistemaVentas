        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    // 'classes' => 'fa-solid fa-scale-balanced',// 'url' => '/admin/roles',
                ...
                [
                    ...
                    'icon'        => 'far fa-circle nav-icon',
                    // 'url' => '/admin/roles',
                    // 'classes' => 'fa-solid fa-scale-balanced',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'icon'        => 'far fa-circle nav-icon',
                    'route' => 'admin.products.index',/* 'url' => '#', */
                ],
                [
                    'text' => 'Registro',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'route' => 'admin.shopping.index',/* 'url' => '#', */
                ],
                [
                    'text' => 'Registro',
                    'route' => 'admin.shopping.create',
                    'icon'        => 'far fa-circle nav-icon',
                    // 'url' => '#',
                ],
            ],
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'icon'        => 'far fa-circle nav-icon',
                    'route' => 'admin.providers.index',// 'url' => '#',
                ],
                [
                    'text' => 'Registro',
